/*
* First screen the user sees after installing the app
* Once the key is set, user should never see this screen again.
*/
    ...
    bt_submit.setOnClickListener(v -> {
      ...
      if (pass.equals("") || confim_pass.equals("")) {
        ...
        if (pass.equals(confim_pass)) {
          ...
          // Insert the record after hashing and salting.
          userdb.insert(EnNotesContract.EnNotesEntry.TABLE_NAME_USER_KEY, null, values);
          // Redirect the user to the challenge page.
