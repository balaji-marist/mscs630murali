/*
* This activity presents the user with a new note screen.
* saving a note here creates an encrypted record in the database
*/
...
public class NewNote extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String dt = DateFormat.getDateInstance(DateFormat.MEDIUM)
        .format(new Date());
    ...
    fabs.setOnClickListener(v -> {
      ...
      values.put(EnNotesContract.EnNotesEntry.COLUMN_CONTENT,
          encrypted_content);
      values.put(EnNotesContract.EnNotesEntry.COLUMN_DATE,
          str_date_stamp);

      long rowid = notesdb.insert(EnNotesContract.EnNotesEntry.TABLE_NAME,
          null, values);
      Toast.makeText(this, "Your secret is a secret now," +
          " only you can decrypt it.", Toast.LENGTH_LONG).show();
  ...
  // Function to handle the back button in action bar.
